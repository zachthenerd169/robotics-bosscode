...
//server on robot --> receives commands from client.java/control.java and then relays them to the arduino
...
{
	public static String ipAddress = "172.17.57.104";
...
//            (new TwoWaySerialComm()).connect("/dev/tty.usbmodemfd131");
            ...
            (new TwoWaySerialComm()).connect("COM" + com);
        }
        catch ( Exception e )
        {
